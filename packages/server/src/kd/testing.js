...
import {makeSerializedKDT, deserializeKDT, kNearest, makeUserNode} from './utilities';
import { getTrackIDsInPlaylist, getTracksAudioFeatures, getTopUserTracks } from '../spotify/index.js';
...
const main = async () => {
  const myTopTracksRes = await getTopUserTracks("Bearer BQCX1DGfIa5bkKzs6mVdaYUgMdYc1LjUEueu8lv-5Og0FX0Y88gfGSp2mXKNBRgWwdyD8_BjPinKSoyTkeZVSSJJzBFZI7dWyKpSeTsZN4DN0tHlIj8JlRRU31C1R4uGHg-ojPq1bM8UW87fU122EPPtNSeorNkVn6Mf");
